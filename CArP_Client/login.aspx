<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="carpClient.login" %>
...
<script>
    ...
    <div id="textuser">   Enter user name: 
        ...
        submit
         ...
         <a style="position:absolute;left:20px;bottom:10px;" href="http://localhost:7543/signup.aspx">signup here</a>
        </div>
    </form>
</body>
</html>
